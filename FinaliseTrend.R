...
vm<-read.csv(file=paste("//file/herman/R/OA/08/02/2015/Water Quality/ROutput/validDataForTrend_monthly_",StartYear,"-",EndYear,".csv",sep=""))
vb<-read.csv(file=paste("//file/herman/R/OA/08/02/2015/Water Quality/ROutput/validDataForTrend_bimonthly_",StartYear,"-",EndYear,".csv",sep=""))
vq<-read.csv(file=paste("//file/herman/R/OA/08/02/2015/Water Quality/ROutput/validDataForTrend_quarterly_",StartYear,"-",EndYear,".csv",sep=""))

# Trend results
m<-read.csv(file=paste("//file/herman/R/OA/08/02/2015/Water Quality/ROutput/trend_monthly_",StartYear,"-",EndYear,".csv",sep=""))
b<-read.csv(file=paste("//file/herman/R/OA/08/02/2015/Water Quality/ROutput/trend_bimonthly_",StartYear,"-",EndYear,".csv",sep=""))
q<-read.csv(file=paste("//file/herman/R/OA/08/02/2015/Water Quality/ROutput/trend_quarterly_",StartYear,"-",EndYear,".csv",sep=""))
...
# Load exclusion file
exclusions <- read.csv(file="//file/herman/R/OA/08/02/2015/Water Quality/RScript/lawa_state/TrendExclusion2015.csv",stringsAsFactors=FALSE)
...
mbq <- mbq[mbq$Exclusion==FALSE,c(1:39)]  # <-- only retain those records where the exclusion column contains a FALSE value.
...
# OUTPUT data to CSVs
write.csv(vmbq,file="//file/herman/R/OA/08/02/2015/Water Quality/ROutput/validDataForTrend_combined.csv")  ## LOG PASS-FAIL for Trend analysis
rm(vmbq,vmbq5,vmbq9)
write.csv(mbq,file="//file/herman/R/OA/08/02/2015/Water Quality/ROutput/trend_sites_freq_combined.csv")    ## COMBINED TREND DATA FOR 5 AND 10 YEARS
write.csv(z,file="//file/herman/R/OA/08/02/2015/Water Quality/ROutput/trend_catchment_region.csv")         ## 
...
write.csv(e,file="//file/herman/R/OA/08/02/2015/Water Quality/ROutput/trend_sites_catchment_region.csv")
setwd(od)