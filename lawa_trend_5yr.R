...
# tss_url <- "http://hilltopdev.horizons.govt.nz:8080/lawa2015trend05.lawa?"
...
#write.csv(lawadata,"//file/herman/R/OA/08/02/2015/Water Quality/ROutput/LAWA_RAW_DATA_TREND05yr.csv")
